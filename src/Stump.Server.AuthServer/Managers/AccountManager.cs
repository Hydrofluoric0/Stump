...
namespace Stump.Server.AuthServer.Managers
{
    public class AccountManager : DataManager<AccountManager>
    {
        ...
        public override void Initialize()
        {
            ...
            UserGroupDefaultValues.CreateDefaultValues();
        }
        ...
        public UserGroupRecord FindUserGroup(int role)
        {
            var query = string.Format(UserGroupRelator.FindUserGroupByRole, role);
            return Database.Query<UserGroupRecord>(query).SingleOrDefault();
        }
