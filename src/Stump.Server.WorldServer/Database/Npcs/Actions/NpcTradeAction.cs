...
namespace Stump.Server.WorldServer.Database.Npcs.Actions
{
    ...
    public class NpcTradeAction : NpcActionDatabase
    {
        ...
        public override void Execute(Npc npc, Character character)
        {
            ...
            {
                character.OpenPopup("En echangeant vos orbes contre des kamas, faites attention à ne pas être déjà à la limite de 10mm, si c'est le cas rendez vous en banque pour y déposer des kamas ( peut comporter 10mm elle aussi ! )");
            }
        }
    }
}