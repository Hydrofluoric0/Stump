...
namespace Stump.Server.WorldServer.Database.Items.Shops
{
    ...
    public class NpcItem : ItemToSell, IAutoGeneratedRecord
    {
        ...
        public double? CustomPrice
        {
            get
            {
                if (m_customPrice.HasValue)
                    return m_customPrice; //Si y'a une valeur en bdd ça la met direct.
                else
                {
                    int multiplicateur = 0;
                    long result = 0;

                    if (NpcShopId == 3 | NpcShopId == 7 | NpcShopId == 1 | NpcShopId == 2 | NpcShopId == 30423 | NpcShopId == 30424 | NpcShopId == 30421 | NpcShopId == 10134 | NpcShopId == 10131 | NpcShopId == 151 | NpcShopId == 30422)
                    {
                    ...
                    else if (NpcShopId == 10128)
                    {
                        result = Item.Level * 10;
                        CustomPrice = result;
                    }
