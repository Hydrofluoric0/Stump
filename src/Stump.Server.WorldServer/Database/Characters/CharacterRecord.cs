...
namespace Stump.Server.WorldServer.Database.Characters
{
    ...
    public class CharacterRecord : IAutoGeneratedRecord, ISaveIntercepter
    {
        ...
        public int MaxStatsPvp
        {
            get;
            set;
        }

        public int ForceStatsPointRetirePvp
        {
            get;
            set;
        }

        public int IntelligenceStatsPointRetirePvp
        {
            get;
            set;
        }

        public int ChanceStatsPointRetirePvp
        {
            get;
            set;
        }

        public int AgiliteStatsPointRetirePvp
        {
            get;
            set;
        }
