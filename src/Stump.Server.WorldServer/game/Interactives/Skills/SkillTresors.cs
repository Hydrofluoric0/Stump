        ...
        public override int StartExecute(Character character)
        {
            ...
            if (character.Record.TreasureSearch == 0)
            {
                ...
                if (rndNumber == 1)
                {
                    ...
                    character.DisplayNotification("Vous êtes maintenant à la recherche d'un trésor.", NotificationEnum.INFORMATION);
                    character.SendServerMessage("Le trésor se trouve quelque part dans <b>Astrub</b>.\n" +
                        "Utilisez la commande <b>.fouiller</b> pour chercher un trésor sur la carte où vous êtes.\n" +
                        "Utilisez la commande <b>.abandonner</b> pour terminer votre chasse.");

                    if (!character.HasEmote(EmotesEnum.EMOTE_CHERCHER_UN_TRESOR))
                    {
                        character.AddEmote(EmotesEnum.EMOTE_CHERCHER_UN_TRESOR);
                    }
                    character.PlayEmote(EmotesEnum.EMOTE_CHERCHER_UN_TRESOR);
                }
                else if (rndNumber == 2)
                {
                ...
                else if (rndNumber == 4)
                {
                    ...
                    character.DisplayNotification("Vous êtes maintenant à la recherche d'un trésor.", NotificationEnum.INFORMATION);
                    character.SendServerMessage("Le trésor se trouve quelque part dans <b>Bonta</b>.\n" +
                        "Utilisez la commande <b>.fouiller</b> pour chercher un trésor sur la carte où vous êtes.\n" +
                        "Utilisez la commande <b>.abandonner</b> pour terminer votre chasse.");
                ...
                else if (rndNumber == 7)
                {
                    ...
                    character.DisplayNotification("Vous êtes maintenant à la recherche d'un trésor.", NotificationEnum.INFORMATION);
                    character.SendServerMessage("Le trésor se trouve quelque part dans <b>Brâkmar</b>.\n" +
                        "Utilisez la commande <b>.fouiller</b> pour chercher un trésor sur la carte où vous êtes.\n" +
                        "Utilisez la commande <b>.abandonner</b> pour terminer votre chasse.");
                ...
                if (character.Record.TreasureSearch == 1)
                {
                    if (rndNumber_2 == 1)
                    {
                        character.Record.TreasureMapCoffre = 192416776;
                    ...
                    if (rndNumber_2 == 3)
                    {
                        character.Record.TreasureMapCoffre = 191106050;
                    ...
                    if (rndNumber_2 == 20)
                    {
                        character.Record.TreasureMapCoffre = 192413702;
            ...
            {
                character.SendServerMessage("Vous ne pouvez avoir deux chasses au trésor de même type simultanément. Vous devez abandonner l'ancienne avant d'en prendre une nouvelle.");
            }
