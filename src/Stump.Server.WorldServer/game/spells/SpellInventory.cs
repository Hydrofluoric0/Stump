...
namespace Stump.Server.WorldServer.Game.Spells
{
    public class SpellInventory : IEnumerable<CharacterSpell>
    {
        ...
        public CharacterSpell LearnSpell(SpellTemplate template, short level)
        {
            var record = SpellManager.Instance.CreateSpellRecord(Owner.Record, template);
        ...
        public CharacterSpell LearnSpellVariant(int id)
        {
            var template = SpellManager.Instance.GetSpellTemplate(id);

            return template == null ? null : LearnSpellVariant(template);
        }

        public CharacterSpell LearnSpellVariant(SpellTemplate template)
        {
            var record = SpellManager.Instance.CreateSpellRecord(Owner.Record, template);
        ...
        public CharacterSpell LearnSpellVariant(SpellTemplate template, short level)
        {
            var record = SpellManager.Instance.CreateSpellRecord(Owner.Record, template);
            record.Level = level;
            var spell = new CharacterSpell(record);
