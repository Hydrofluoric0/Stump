...
namespace Stump.Server.WorldServer.Game.Effects
{
    public class EffectManager : DataManager<EffectManager>
    {
        ...
        public static readonly Dictionary<CharacteristicEnum, double> POWER_PER_STAT = new Dictionary<CharacteristicEnum, double> {
            ...
            { CharacteristicEnum.FIRE_REDUCTION_PERCENT, 15 },
            { CharacteristicEnum.WATER_REDUCTION_PERCENT, 15 },
            { CharacteristicEnum.AIR_REDUCTION_PERCENT, 15 },
            { CharacteristicEnum.EARTH_REDUCTION_PERCENT, 15 },
            { CharacteristicEnum.NEUTRAL_REDUCTION_PERCENT, 15 },
        ...
        public static readonly Dictionary<CharacteristicEnum, double> MaxOver = new Dictionary<CharacteristicEnum, double>
        {
            ...
            {CharacteristicEnum.REFLECT, 3},
            {CharacteristicEnum.SUMMONS, 3},
            {CharacteristicEnum.CRITICAL_HITS, 5},
            {CharacteristicEnum.HEALS, 10},
            {CharacteristicEnum.DAMAGE, 6},
            {CharacteristicEnum.TRAPS_BONUS_FIXED, 10},
            {CharacteristicEnum.AP_REDUCTION, 10},
            {CharacteristicEnum.MP_REDUCTION, 10},
            {CharacteristicEnum.AP_LOSS_RES, 10},
            {CharacteristicEnum.MP_LOSS_RES, 10},
            ...
            {CharacteristicEnum.NEUTRAL_DAMAGE_FIXED, 6},
            {CharacteristicEnum.AIR_DAMAGE_FIXED, 6},
            {CharacteristicEnum.FIRE_DAMAGE_FIXED, 6},
            {CharacteristicEnum.EARTH_DAMAGE_FIXED, 6},
            {CharacteristicEnum.WATER_DAMAGE_FIXED, 6},
            {CharacteristicEnum.CRITICAL_DAMAGE, 5},
            {CharacteristicEnum.PUSHBACK_DAMAGE_FIXED, 15},
            {CharacteristicEnum.LOCK, 10},
            {CharacteristicEnum.DODGE, 10},
            {CharacteristicEnum.WISDOM, 30},
            {CharacteristicEnum.PROSPECTING, 20},
            {CharacteristicEnum.POWER, 30},
            {CharacteristicEnum.TRAPS_BONUS_PERCENT, 15},
            ...
            {CharacteristicEnum.STRENGTH, 50},
            {CharacteristicEnum.CHANCE, 50},
            {CharacteristicEnum.INTELLIGENCE, 50},
            {CharacteristicEnum.AGILITY, 50},
            {CharacteristicEnum.WEIGHT, 404},
            {CharacteristicEnum.VITALITY, 200},
            {CharacteristicEnum.INITIATIVE, 400},
        };
