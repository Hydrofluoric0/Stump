...
//                Target.ReduceSpellCost(values[0], (ushort)values[2]);
//            else
//                Target.SpellCostDisable(values[0], values[2]);
...
//            if (values == null) return false;
//            if (Operation == HandlerOperation.APPLY)
//                Target.IncreaseRange(values[0], (ushort)values[2]);
//            else
//                Target.IncreaseRangeDisable(values[0], values[2]);
...
//            if (values == null) return false;
//            if (Operation == HandlerOperation.APPLY)
//                Target.ReduceDelay(values[0], (ushort)values[2]);
//            else
...
//            if (values == null) return false;
//            if (Operation == HandlerOperation.APPLY)
//                Target.AddMaxCastPerTurn(values[0], (ushort)values[2]);
//            else
...
//            if (values == null) return false;
//            if (Operation == HandlerOperation.APPLY)
//                Target.AddMaxCastPerTarget(values[0], (ushort)values[2]);
//            else
...
//            if (values == null) return false;
//            if (Operation == HandlerOperation.APPLY)
//                Target.AddDamage(values[0], (ushort)values[2]);
//            else
...
//            if (values == null) return false;
//            if (Operation == HandlerOperation.APPLY)
//                Target.AddHeal(values[0], (ushort)values[2]);
//            else
...
//            if (values == null) return false;
//            if (Operation == HandlerOperation.APPLY)
//                Target.AddCritical(values[0], (ushort)values[2]);
//            else
