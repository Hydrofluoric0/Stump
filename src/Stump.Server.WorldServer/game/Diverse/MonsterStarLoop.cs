...
namespace Game.Vote
{
    public class MonsterStarLoop : Singleton<MonsterStarLoop>
    {
        ...
        private static int _queueRefresherElapsedTime = 540000;//2H 7200000
        ...
        private void StartLoop()
        {
            try
            {
                ...
                World.Instance.SendAnnounce("<b>Serveur :</b> Les étoiles des monstres ont été fixés au maximum ! Bon jeu sur <b>Nonobstant</b>.", System.Drawing.Color.AliceBlue);
