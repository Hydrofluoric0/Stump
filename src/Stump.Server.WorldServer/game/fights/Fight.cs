...
namespace Stump.Server.WorldServer.Game.Fights
{
        ...
        where TBlueTeam : FightTeam
    {
        ...
        public void CancelFight()
        {
            ...
            {
                //if (FightType == FightTypeEnum.FIGHT_TYPE_PvM && Winners == character.Team && character.IsDonjonMap(Map.Id))
                    character.RejoinMap();
            }
        ...
        protected virtual void OnCharacterAdded(CharacterFighter fighter)
        {
            ...
            //if (character.IsDonjonMap(this.Map.Id))
            //    character.Record.BackDj = character.Map.Id;
            ...
            if (castHandler.Spell.Id == 0)
                ForEach(
                    ...
                    ActionsHandler.SendGameActionFightCloseCombatMessage(entry.Client, caster, target,
                        ...
                        castHandler.Informations.Critical, !caster.IsVisibleFor(entry) || castHandler.Informations.Silent, 0), true);
            else
            {
