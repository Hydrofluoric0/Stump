...
{
    [ItemId(ItemIdEnum.FUYARD_MAJEUR_12627)] // ID ITEM - NOM 
    public class BouclierTemporel : BasePlayerItem
    {
        public BouclierTemporel(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9904; //ID SORT
            string name = "Bouclier Temporel";//NOM SORT
