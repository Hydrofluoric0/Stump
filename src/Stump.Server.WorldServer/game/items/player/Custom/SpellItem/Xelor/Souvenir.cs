...
{
    [ItemId(ItemIdEnum.FURIBOND_12723)] // ID ITEM - NOM 
    public class Souvenir : BasePlayerItem
    {
        public Souvenir(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9888; //ID SORT
            string name = "Souvenir";//NOM SORT
