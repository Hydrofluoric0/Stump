...
{
    [ItemId(ItemIdEnum.SURVIVANT_12725)] // ID ITEM - NOM 
    public class Engrenage : BasePlayerItem
    {
        public Engrenage(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9906; //ID SORT
            string name = "Engrenage";//NOM SORT
