...
{
    [ItemId(ItemIdEnum.FURIBOND_MAJEUR_12724)] // ID ITEM - NOM 
    public class Rouage : BasePlayerItem
    {
        public Rouage(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9890; //ID SORT
            string name = "Rouage";//NOM SORT
