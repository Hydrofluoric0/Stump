...
{
    [ItemId(ItemIdEnum.FUYARD_MINEUR_12625)] // ID ITEM - NOM 
    public class Désyncronisation : BasePlayerItem
    {
        public Désyncronisation(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9903; //ID SORT
            string name = "Désyncronisation";//NOM SORT
