...
{
    [ItemId(ItemIdEnum.SURVIVANT_MAJEUR_12726)] // ID ITEM - NOM 
    public class Perturbation : BasePlayerItem
    {
        public Perturbation(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9895; //ID SORT
            string name = "Perturbation";//NOM SORT
