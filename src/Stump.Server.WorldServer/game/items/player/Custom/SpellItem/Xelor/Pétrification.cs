...
{
    [ItemId(ItemIdEnum.SAVANT_MINEUR_12718)] // ID ITEM - NOM 
    public class Pétrification : BasePlayerItem
    {
        public Pétrification(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9887; //ID SORT
            string name = "Pétrification";//NOM SORT
