...
{
    [ItemId(ItemIdEnum.RALENTISSEUR_MINEUR_12628)] // ID ITEM - NOM 
    public class Prémonition : BasePlayerItem
    {
        public Prémonition(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9900; //ID SORT
            string name = "Prémonition";//NOM SORT
