...
{
    [ItemId(ItemIdEnum.RALENTISSEUR_12629)] // ID ITEM - NOM 
    public class Glas : BasePlayerItem
    {
        public Glas(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9907; //ID SORT
            string name = "Glas";//NOM SORT
