...
{
    [ItemId(ItemIdEnum.VIGOUREUX_16331)] // ID ITEM - NOM 
    public class RonceParalysante : BasePlayerItem
    {
        public RonceParalysante(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9768; //ID SORT
            string name = "Ronce Paralysante";//NOM SORT
