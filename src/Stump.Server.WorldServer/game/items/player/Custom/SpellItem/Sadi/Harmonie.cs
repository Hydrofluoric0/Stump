...
{
    [ItemId(ItemIdEnum.VIGOUREUX_MINEUR_16330)] // ID ITEM - NOM 
    public class Harmonie : BasePlayerItem
    {
        public Harmonie(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9770; //ID SORT
            string name = "Harmonie";//NOM SORT
