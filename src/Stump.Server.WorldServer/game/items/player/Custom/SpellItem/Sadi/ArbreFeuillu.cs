...
{
    [ItemId(ItemIdEnum.CARAPACE_FEU_MAJEUR_16323)] // ID ITEM - NOM 
    public class ArbreFeuillu : BasePlayerItem
    {
        public ArbreFeuillu(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9749; //ID SORT
            string name = "Arbre Feuillu";//NOM SORT
