...
{
    [ItemId(ItemIdEnum.CARAPACE_EAU_16325)] // ID ITEM - NOM 
    public class MontéedeSève : BasePlayerItem
    {
        public MontéedeSève(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9752; //ID SORT
            string name = "Montée de Sève";//NOM SORT
