...
{
    [ItemId(ItemIdEnum.CARAPACE_EAU_MINEUR_16324)] // ID ITEM - NOM 
    public class BrousailleEmpoisonnée : BasePlayerItem
    {
        public BrousailleEmpoisonnée(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9748; //ID SORT
            string name = "Brousaille Empoisonnée";//NOM SORT
