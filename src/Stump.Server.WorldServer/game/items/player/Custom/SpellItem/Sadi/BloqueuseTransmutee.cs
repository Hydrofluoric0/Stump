...
{
    [ItemId(ItemIdEnum.CARAPACE_AIR_MINEUR_16327)] // ID ITEM - NOM 
    public class BloqueuseTransmutee : BasePlayerItem
    {
        public BloqueuseTransmutee(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 193; //ID SORT
            string name = "Bloqueuse Transmutée";//NOM SORT
