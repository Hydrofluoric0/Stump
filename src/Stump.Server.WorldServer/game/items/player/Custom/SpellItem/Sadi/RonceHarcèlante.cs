...
{
    [ItemId(ItemIdEnum.CARAPACE_AIR_16328)] // ID ITEM - NOM 
    public class RonceHarcèlante : BasePlayerItem
    {
        public RonceHarcèlante(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9765; //ID SORT
            string name = "Ronce Harcèlante";//NOM SORT
