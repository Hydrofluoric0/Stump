...
{
    [ItemId(ItemIdEnum.CARAPACE_FEU_16322)] // ID ITEM - NOM 
    public class SurpuissanteTransmutée : BasePlayerItem
    {
        public SurpuissanteTransmutée(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 187; //ID SORT
            string name = "Surpuissante Transmutée";//NOM SORT
