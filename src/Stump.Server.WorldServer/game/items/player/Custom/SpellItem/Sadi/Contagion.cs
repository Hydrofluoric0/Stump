...
{
    [ItemId(ItemIdEnum.CARAPACE_AIR_MAJEUR_16329)] // ID ITEM - NOM 
    public class Contagion : BasePlayerItem
    {
        public Contagion(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9766; //ID SORT
            string name = "Contagion";//NOM SORT
