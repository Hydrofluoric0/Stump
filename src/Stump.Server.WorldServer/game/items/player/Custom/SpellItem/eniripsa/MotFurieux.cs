...
{
    [ItemId(ItemIdEnum.POUSSEUR_MAJEUR_12642)] // ID ITEM - NOM 
    public class MotFurieux : BasePlayerItem
    {
        public MotFurieux(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9407; //ID SORT
            string name = "Mot Furieux";//NOM SORT
