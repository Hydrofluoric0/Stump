...
{
    [ItemId(ItemIdEnum.POUSSEUR_MINEUR_12640)] // ID ITEM - NOM 
    public class MotDéfendu : BasePlayerItem
    {
        public MotDéfendu(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9401; //ID SORT
            string name = "Mot Défendu";//NOM SORT
