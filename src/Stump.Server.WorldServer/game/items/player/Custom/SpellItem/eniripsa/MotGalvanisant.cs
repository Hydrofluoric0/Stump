...
{
    [ItemId(ItemIdEnum.ADAMANTIN_MAJEUR_12645)] // ID ITEM - NOM 
    public class MotGalvanisant : BasePlayerItem
    {
        public MotGalvanisant(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9412; //ID SORT
            string name = "Mot Galvanisant";//NOM SORT
