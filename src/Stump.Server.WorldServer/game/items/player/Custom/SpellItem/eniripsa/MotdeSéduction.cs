...
{
    [ItemId(ItemIdEnum.INSAISISSABLE_MAJEUR_12639)] // ID ITEM - NOM 
    public class MotdeSéduction : BasePlayerItem
    {
        public MotdeSéduction(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9398; //ID SORT
            string name = "Mot de Séduction";//NOM SORT
