...
{
    [ItemId(ItemIdEnum.INSAISISSABLE_12638)] // ID ITEM - NOM 
    public class Motdaffection : BasePlayerItem
    {
        public Motdaffection(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9318; //ID SORT
            string name = "Flèche Percutante";//NOM SORT
