...
{
    [ItemId(ItemIdEnum.POUSSEUR_12641)] // ID ITEM - NOM 
    public class MotdAgonie : BasePlayerItem
    {
        public MotdAgonie(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9404; //ID SORT
            string name = "Mot d'Agonie";//NOM SORT
