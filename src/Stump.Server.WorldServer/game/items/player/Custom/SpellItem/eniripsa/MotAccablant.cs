...
{
    [ItemId(ItemIdEnum.REMPART_MINEUR_12646)] // ID ITEM - NOM 
    public class MotAccablant : BasePlayerItem
    {
        public MotAccablant(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9409; //ID SORT
            string name = "Mot Accablant";//NOM SORT
