...
{
    [ItemId(ItemIdEnum.REMPART_12647)] // ID ITEM - NOM 
    public class MotEspiègle : BasePlayerItem
    {
        public MotEspiègle(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9400; //ID SORT
            string name = "Mot Espiègle";//NOM SORT
