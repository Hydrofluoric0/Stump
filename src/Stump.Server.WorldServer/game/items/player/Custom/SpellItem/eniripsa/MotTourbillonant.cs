...
{
    [ItemId(ItemIdEnum.ADAMANTIN_MINEUR_12643)] // ID ITEM - NOM 
    public class MotTourbillonant : BasePlayerItem
    {
        public MotTourbillonant(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9408; //ID SORT
            string name = "Mot Tourbillonant";//NOM SORT
