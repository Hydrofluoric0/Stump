...
{
    [ItemId(ItemIdEnum.ADAMANTIN_12644)] // ID ITEM - NOM 
    public class MotdeRalliement : BasePlayerItem
    {
        public MotdeRalliement(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9411; //ID SORT
            string name = "Mot de Ralliement";//NOM SORT
