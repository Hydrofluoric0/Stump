...
{
    [ItemId(ItemIdEnum.SOIGNEUR_MINEUR_12707)] // ID ITEM - NOM 
    public class Correction : BasePlayerItem
    {
        public Correction(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9486; //ID SORT
            string name = "Correction";//NOM SORT
