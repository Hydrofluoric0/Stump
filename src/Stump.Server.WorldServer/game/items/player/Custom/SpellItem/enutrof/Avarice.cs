...
{
    [ItemId(ItemIdEnum.INITIATEUR_MAJEUR_12703)] // ID ITEM - NOM 
    public class Avarice : BasePlayerItem
    {
        public Avarice(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9478; //ID SORT
            string name = "Avarice";//NOM SORT
