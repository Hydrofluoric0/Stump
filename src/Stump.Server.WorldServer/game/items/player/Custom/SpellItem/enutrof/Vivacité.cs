...
{
    [ItemId(ItemIdEnum.PORTEUR_12705)] // ID ITEM - NOM 
    public class Vivacité : BasePlayerItem
    {
        public Vivacité(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9480; //ID SORT
            string name = "Vivacité";//NOM SORT
