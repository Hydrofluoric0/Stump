...
{
    [ItemId(ItemIdEnum.PORTEUR_MAJEUR_12706)] // ID ITEM - NOM 
    public class Opportunité : BasePlayerItem
    {
        public Opportunité(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9482; //ID SORT
            string name = "Opportunité";//NOM SORT
