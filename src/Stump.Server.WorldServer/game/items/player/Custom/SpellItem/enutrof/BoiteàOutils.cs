...
{
    [ItemId(ItemIdEnum.INITIATEUR_12701)] // ID ITEM - NOM 
    public class BoîteàOutils : BasePlayerItem
    {
        public BoîteàOutils(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9473; //ID SORT
            string name = "Boîte à Outils";//NOM SORT
