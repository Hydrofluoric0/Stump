...
{
    [ItemId(ItemIdEnum.PORTEUR_MINEUR_12704)] // ID ITEM - NOM 
    public class BêcheAnimée : BasePlayerItem
    {
        public BêcheAnimée(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9477; //ID SORT
            string name = "Bêche Animée";//NOM SORT
