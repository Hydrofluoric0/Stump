...
{
    [ItemId(ItemIdEnum.INITIATEUR_MINEUR_12702)] // ID ITEM - NOM 
    public class Tourbière : BasePlayerItem
    {
        public Tourbière(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9474; //ID SORT
            string name = "Tourbière";//NOM SORT
