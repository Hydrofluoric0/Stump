...
{
    [ItemId(ItemIdEnum.SOIGNEUR_MAJEUR_12708)] // ID ITEM - NOM 
    public class CoffreRégénérant : BasePlayerItem
    {
        public CoffreRégénérant(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9487; //ID SORT
            string name = "Coffre Régénérant";//NOM SORT
