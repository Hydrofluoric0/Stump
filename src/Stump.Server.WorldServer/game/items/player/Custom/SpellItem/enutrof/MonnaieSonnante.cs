...
{
    [ItemId(ItemIdEnum.RAVAGEUR_NEUTRE_MINEUR_12696)] // ID ITEM - NOM 
    public class MonnaieSonnante : BasePlayerItem
    {
        public MonnaieSonnante(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9469; //ID SORT
            string name = "Monnaie Sonnante";//NOM SORT
