...
{
    [ItemId(ItemIdEnum.RAVAGEUR_TERRE_12698)] // ID ITEM - NOM 
    public class MusetteAnimée : BasePlayerItem
    {
        public MusetteAnimée(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9470; //ID SORT
            string name = "Musette Animée";//NOM SORT
