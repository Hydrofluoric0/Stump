...
{
    [ItemId(ItemIdEnum.DEVASTATEUR_TERRE_MINEUR_16252)] // ID ITEM - NOM 
    public class Torpille : BasePlayerItem
    {
        public Torpille(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9860; //ID SORT
            string name = "Torpille";//NOM SORT
