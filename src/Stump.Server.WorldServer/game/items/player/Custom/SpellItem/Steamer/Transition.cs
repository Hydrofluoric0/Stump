...
{
    [ItemId(ItemIdEnum.FORTIFICATION_MINEURE_16249)] // ID ITEM - NOM 
    public class Transition : BasePlayerItem
    {
        public Transition(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9855; //ID SORT
            string name = "Transition";//NOM SORT
