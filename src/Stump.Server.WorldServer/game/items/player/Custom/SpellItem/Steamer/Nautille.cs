...
{
    [ItemId(ItemIdEnum.DEVASTATEUR_TERRE_MAJEUR_16254)] // ID ITEM - NOM 
    public class Nautille : BasePlayerItem
    {
        public Nautille(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9869; //ID SORT
            string name = "Nautille";//NOM SORT
