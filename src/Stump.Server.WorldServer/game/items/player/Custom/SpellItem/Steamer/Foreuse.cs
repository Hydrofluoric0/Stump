...
{
    [ItemId(ItemIdEnum.FORTIFICATION_MAJEURE_16251)] // ID ITEM - NOM 
    public class Foreuse : BasePlayerItem
    {
        public Foreuse(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9859; //ID SORT
            string name = "Foreuse";//NOM SORT
