...
{
    [ItemId(ItemIdEnum.FORTIFICATION_16250)] // ID ITEM - NOM 
    public class Blindage : BasePlayerItem
    {
        public Blindage(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9858; //ID SORT
            string name = "Blindage";//NOM SORT
