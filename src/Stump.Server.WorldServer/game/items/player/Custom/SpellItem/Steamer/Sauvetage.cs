...
{
    [ItemId(ItemIdEnum.DEVASTATEUR_NEUTRE_MAJEUR_16257)] // ID ITEM - NOM 
    public class Sauvetage : BasePlayerItem
    {
        public Sauvetage(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9866; //ID SORT
            string name = "Sauvetage";//NOM SORT
