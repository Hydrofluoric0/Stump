...
{
    [ItemId(ItemIdEnum.DEVASTATEUR_NEUTRE_MINEUR_16255)] // ID ITEM - NOM 
    public class Arraisonnage : BasePlayerItem
    {
        public Arraisonnage(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9870; //ID SORT
            string name = "Arraisonnage";//NOM SORT
