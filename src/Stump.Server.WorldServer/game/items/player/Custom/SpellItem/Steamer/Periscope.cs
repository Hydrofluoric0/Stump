...
{
    [ItemId(ItemIdEnum.DEVASTATEUR_TERRE_16253)] // ID ITEM - NOM 
    public class Periscope : BasePlayerItem
    {
        public Periscope(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9865; //ID SORT
            string name = "Périscope";//NOM SORT
