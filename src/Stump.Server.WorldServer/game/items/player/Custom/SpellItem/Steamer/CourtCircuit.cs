...
{
    [ItemId(ItemIdEnum.DEVASTATEUR_NEUTRE_16256)] // ID ITEM - NOM 
    public class CourtCircuit : BasePlayerItem
    {
        public CourtCircuit(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9867; //ID SORT
            string name = "Court-Circuit";//NOM SORT
