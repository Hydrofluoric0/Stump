...
{
    [ItemId(ItemIdEnum.ASTUCIEUX_MINEUR_13760)] // ID ITEM - NOM 
    public class ÉpéeVéloce : BasePlayerItem
    {
        public ÉpéeVéloce(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 10008; //ID SORT
            string name = "Épée Véloce";//NOM SORT
