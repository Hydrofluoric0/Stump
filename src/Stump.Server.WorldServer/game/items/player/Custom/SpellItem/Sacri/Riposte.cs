...
{
    [ItemId(ItemIdEnum.CUIRASSE_EAU_12653)] // ID ITEM - NOM 
    public class Riposte : BasePlayerItem
    {
        public Riposte(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9997; //ID SORT
            string name = "Riposte";//NOM SORT
