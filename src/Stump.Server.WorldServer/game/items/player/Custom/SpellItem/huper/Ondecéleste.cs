...
{
    [ItemId(ItemIdEnum.SACCAGEUR_AIR_MINEUR_13784)] // ID ITEM - NOM 
    public class Ondecéleste : BasePlayerItem
    {
        public Ondecéleste(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9577; //ID SORT
            string name = "Onde céleste";//NOM SORT
