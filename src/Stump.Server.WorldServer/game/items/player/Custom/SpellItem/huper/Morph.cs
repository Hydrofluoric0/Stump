...
{
    [ItemId(ItemIdEnum.SACCAGEUR_EAU_MAJEUR_13783)] // ID ITEM - NOM 
    public class Morph : BasePlayerItem
    {
        public Morph(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9582; //ID SORT
            string name = "Morph";//NOM SORT
