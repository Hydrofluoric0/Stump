...
{
    [ItemId(ItemIdEnum.SACCAGEUR_AIR_13785)] // ID ITEM - NOM 
    public class Cataracte : BasePlayerItem
    {
        public Cataracte(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9580; //ID SORT
            string name = "Cataracte";//NOM SORT
