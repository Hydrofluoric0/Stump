...
{
    [ItemId(ItemIdEnum.ENTRAVEUR_MAJEUR_13789)] // ID ITEM - NOM 
    public class Création : BasePlayerItem
    {
        public Création(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9596; //ID SORT
            string name = "Création";//NOM SORT
