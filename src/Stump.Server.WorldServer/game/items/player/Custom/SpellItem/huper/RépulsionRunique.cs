...
{
    [ItemId(ItemIdEnum.CUIRASSE_FEU_12678)] // ID ITEM - NOM 
    public class Pillage : BasePlayerItem
    {
        public Pillage(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
