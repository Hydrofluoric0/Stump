...
{
    [ItemId(ItemIdEnum.ENTRAVEUR_MINEUR_13787)] // ID ITEM - NOM 
    public class GardienElémentaire : BasePlayerItem
    {
        public GardienElémentaire(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9589; //ID SORT
            string name = "Gardien Elémentaire";//NOM SORT
