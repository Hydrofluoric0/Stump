...
{
    [ItemId(ItemIdEnum.ENTRAVEUR_13788)] // ID ITEM - NOM 
    public class SurchargeRunique : BasePlayerItem
    {
        public SurchargeRunique(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9593; //ID SORT
            string name = "Surcharge Runique";//NOM SORT
