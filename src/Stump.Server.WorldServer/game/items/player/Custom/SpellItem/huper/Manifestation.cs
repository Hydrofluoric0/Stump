...
{
    [ItemId(ItemIdEnum.SACCAGEUR_EAU_13782)] // ID ITEM - NOM 
    public class Manifestation : BasePlayerItem
    {
        public Manifestation(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9579; //ID SORT
            string name = "Manifestation";//NOM SORT
