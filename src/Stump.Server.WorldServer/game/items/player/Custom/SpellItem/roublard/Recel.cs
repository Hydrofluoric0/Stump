...
{
    [ItemId(ItemIdEnum.VAGABOND_MINEUR_13751)] // ID ITEM - NOM 
    public class Recel : BasePlayerItem
    {
        public Recel(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 10026; //ID SORT
            string name = "Recel";//NOM SORT
