...
{
    [ItemId(ItemIdEnum.BLOQUEUR_MINEUR_13748)] // ID ITEM - NOM 
    public class imposture : BasePlayerItem
    {
        public imposture(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 10038; //ID SORT
            string name = "imposture";//NOM SORT
