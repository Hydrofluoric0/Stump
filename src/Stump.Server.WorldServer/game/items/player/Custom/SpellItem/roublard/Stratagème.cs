...
{
    [ItemId(ItemIdEnum.VAGABOND_13752)] // ID ITEM - NOM 
    public class Stratagème : BasePlayerItem
    {
        public Stratagème(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 10025; //ID SORT
            string name = "Stratagème";//NOM SORT
