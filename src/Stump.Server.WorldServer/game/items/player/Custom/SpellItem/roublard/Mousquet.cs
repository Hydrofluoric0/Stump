...
{
    [ItemId(ItemIdEnum.VAGABOND_MAJEUR_13753)] // ID ITEM - NOM 
    public class Mousquet : BasePlayerItem
    {
        public Mousquet(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 10022; //ID SORT
            string name = "Mousquet";//NOM SORT
