...
{
    [ItemId(ItemIdEnum.DOCTEUR_13755)] // ID ITEM - NOM 
    public class Etourpille : BasePlayerItem
    {
        public Etourpille(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 10019; //ID SORT
            string name = "Etourpille";//NOM SORT
