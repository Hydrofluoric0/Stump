...
{
    [ItemId(ItemIdEnum.CUIRASSE_EAU_MAJEUR_12654)] // ID ITEM - NOM 
    public class Désolation : BasePlayerItem
    {
        public Désolation(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9996; //ID SORT
            string name = "Désolation";//NOM SORT
