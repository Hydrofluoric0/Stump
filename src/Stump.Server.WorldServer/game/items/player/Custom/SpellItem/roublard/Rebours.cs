...
{
    [ItemId(ItemIdEnum.DOCTEUR_MINEUR_13754)] // ID ITEM - NOM 
    public class Rebours : BasePlayerItem
    {
        public Rebours(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 2811; //ID SORT
            string name = "Rebours";//NOM SORT
