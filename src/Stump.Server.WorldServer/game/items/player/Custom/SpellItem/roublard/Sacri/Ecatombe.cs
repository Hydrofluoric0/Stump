...
{
    [ItemId(ItemIdEnum.REMPART_MAJEUR_12648)] // ID ITEM - NOM 
    public class Ecatombe : BasePlayerItem
    {
        public Ecatombe(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9993; //ID SORT
            string name = "Ecatombe";//NOM SORT
