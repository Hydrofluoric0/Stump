...
{
    [ItemId(ItemIdEnum.BLOQUEUR_MAJEUR_13750)] // ID ITEM - NOM 
    public class Croissement : BasePlayerItem
    {
        public Croissement(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 10029; //ID SORT
            string name = "Croissement";//NOM SORT
