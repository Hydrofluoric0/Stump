...
{
    [ItemId(ItemIdEnum.CUIRASSE_EAU_MINEUR_12652)] // ID ITEM - NOM 
    public class Déchaînement : BasePlayerItem
    {
        public Déchaînement(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9998; //ID SORT
            string name = "Déchaînement";//NOM SORT
