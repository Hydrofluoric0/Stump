...
{
    [ItemId(ItemIdEnum.CUIRASSE_AIR_12650)] // ID ITEM - NOM 
    public class Cautérisation : BasePlayerItem
    {
        public Cautérisation(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9990; //ID SORT
            string name = "Cautérisation";//NOM SORT
