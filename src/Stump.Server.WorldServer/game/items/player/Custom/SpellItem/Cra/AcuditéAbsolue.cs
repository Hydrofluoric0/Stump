...
{
    [ItemId(ItemIdEnum.FURIBOND_MINEUR_12722)] // ID ITEM - NOM 
    public class AcuditéAbsolue : BasePlayerItem
    {
        public AcuditéAbsolue(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9306; //ID SORT
            string name = "Acudité Absolue";//NOM SORT
