...
{
    [ItemId(ItemIdEnum.SAVANT_MAJEUR_12719)] // ID ITEM - NOM 
    public class FlècheDévorante : BasePlayerItem
    {
        public FlècheDévorante(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9317; //ID SORT
            string name = "Flèche Dévorante";//NOM SORT
