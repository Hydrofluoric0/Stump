...
{
    [ItemId(ItemIdEnum.ACROBATE_12713)] // ID ITEM - NOM 
    public class Flècheérosive : BasePlayerItem
    {
        public Flècheérosive(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9302; //ID SORT
            string name = "Flèche Érosive";//NOM SORT
