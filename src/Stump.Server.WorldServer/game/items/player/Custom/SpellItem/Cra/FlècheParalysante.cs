...
{
    [ItemId(ItemIdEnum.ACROBATE_MAJEUR_12714)] // ID ITEM - NOM 
    public class FlècheParalysante : BasePlayerItem
    {
        public FlècheParalysante(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9304; //ID SORT
            string name = "Flèche Paralysante";//NOM SORT
