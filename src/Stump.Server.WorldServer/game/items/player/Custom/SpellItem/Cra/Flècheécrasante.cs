...
{
    [ItemId(ItemIdEnum.ACROBATE_MINEUR_12712)] // ID ITEM - NOM 
    public class Flècheécrasante : BasePlayerItem
    {
        public Flècheécrasante(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9308; //ID SORT
            string name = "Flèche Écrasante";//NOM SORT
