...
{
    [ItemId(ItemIdEnum.JOUEUR_MAJEUR_12716)] // ID ITEM - NOM 
    public class FlècheMassacrante : BasePlayerItem
    {
        public FlècheMassacrante(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9313; //ID SORT
            string name = "Flèche Massacrante";//NOM SORT
