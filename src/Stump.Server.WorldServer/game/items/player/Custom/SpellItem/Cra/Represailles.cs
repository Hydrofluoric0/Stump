...
{
    [ItemId(ItemIdEnum.JOUEUR_MINEUR_12717)] // ID ITEM - NOM 
    public class represaille : BasePlayerItem
    {
        public represaille(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9321; //ID SORT
            string name = "Représailles";//NOM SORT
