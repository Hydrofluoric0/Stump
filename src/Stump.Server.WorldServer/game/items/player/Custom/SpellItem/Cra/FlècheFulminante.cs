...
{
    [ItemId(ItemIdEnum.SAVANT_12720)] // ID ITEM - NOM 
    public class FlècheFulminante : BasePlayerItem
    {
        public FlècheFulminante(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
