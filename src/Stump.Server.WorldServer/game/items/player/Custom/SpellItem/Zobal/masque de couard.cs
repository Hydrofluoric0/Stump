...
{
    [ItemId(ItemIdEnum.EQUILIBRISTE_MINEUR_13763)] // ID ITEM - NOM 
    public class MasqueDeCouard : BasePlayerItem
    {
        public MasqueDeCouard(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9920; //ID SORT
            string name = "Masque De Couard";//NOM SORT
