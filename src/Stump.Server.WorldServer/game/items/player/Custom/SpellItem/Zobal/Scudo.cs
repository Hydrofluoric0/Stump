...
{
    [ItemId(ItemIdEnum.EQUILIBRISTE_MAJEUR_13765)] // ID ITEM - NOM 
    public class Scudo : BasePlayerItem
    {
        public Scudo(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9926; //ID SORT
            string name = "Scudo";//NOM SORT
