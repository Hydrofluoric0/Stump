...
{
    [ItemId(ItemIdEnum.TAQUIN_MAJEUR_13768)] // ID ITEM - NOM 
    public class Ginga : BasePlayerItem
    {
        public Ginga(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 99431; //ID SORT
            string name = "Ginga";//NOM SORT
