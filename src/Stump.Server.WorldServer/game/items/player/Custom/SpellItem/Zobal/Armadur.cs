...
{
    [ItemId(ItemIdEnum.EQUILIBRISTE_13764)] // ID ITEM - NOM 
    public class Armadur : BasePlayerItem
    {
        public Armadur(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9925; //ID SORT
            string name = "Armadur";//NOM SORT
