...
{
    [ItemId(ItemIdEnum.BASTION_MINEUR_13769)] // ID ITEM - NOM 
    public class Comedie : BasePlayerItem
    {
        public Comedie(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9932; //ID SORT
            string name = "Comedie";//NOM SORT
