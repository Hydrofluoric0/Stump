...
{
    [ItemId(ItemIdEnum.TAQUIN_MINEUR_13766)] // ID ITEM - NOM 
    public class Masquedelhystérique : BasePlayerItem
    {
        public Masquedelhystérique(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9928; //ID SORT
            string name = "Masque de l'hystérique";//NOM SORT
