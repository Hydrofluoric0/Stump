...
{
    [ItemId(ItemIdEnum.PRECURSEUR_MINEUR_13805)] // ID ITEM - NOM 
    public class Toupet : BasePlayerItem
    {
        public Toupet(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9323; //ID SORT
            string name = "Toupet";//NOM SORT
