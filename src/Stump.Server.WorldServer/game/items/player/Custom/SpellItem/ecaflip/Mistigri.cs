...
{
    [ItemId(ItemIdEnum.PUISSANT_MAJEUR_13825)] // ID ITEM - NOM 
    public class Mistigri : BasePlayerItem
    {
        public Mistigri(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9333; //ID SORT
            string name = "Mistigri";//NOM SORT
