...
namespace Stump.Server.WorldServer.Game.Items.Player.Custom
{
    ...
    public class Mésaventure : BasePlayerItem
    {
        public Mésaventure(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9338; //ID SORT
            string name = "Mésaventure";//NOM SORT
