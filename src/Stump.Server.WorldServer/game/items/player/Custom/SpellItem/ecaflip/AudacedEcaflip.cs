...
{
    [ItemId(ItemIdEnum.RALENTISSEUR_MAJEUR_12630)] // ID ITEM - NOM 
    public class AudacedEcaflip : BasePlayerItem
    {
        public AudacedEcaflip(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9341; //ID SORT
            string name = "Audace d'Ecaflip";//NOM SORT
