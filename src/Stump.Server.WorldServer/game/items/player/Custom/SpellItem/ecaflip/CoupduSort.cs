...
{
    [ItemId(ItemIdEnum.PUISSANT_MINEUR_13823)] // ID ITEM - NOM 
    public class CoupduSort : BasePlayerItem
    {
        public CoupduSort(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9330; //ID SORT
            string name = "Coup du Sort";//NOM SORT
