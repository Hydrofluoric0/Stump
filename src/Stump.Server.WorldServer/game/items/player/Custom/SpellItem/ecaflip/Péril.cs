...
{
    [ItemId(ItemIdEnum.PUISSANT_13824)] // ID ITEM - NOM 
    public class Péril : BasePlayerItem
    {
        public Péril(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9329; //ID SORT
            string name = "Péril";//NOM SORT
