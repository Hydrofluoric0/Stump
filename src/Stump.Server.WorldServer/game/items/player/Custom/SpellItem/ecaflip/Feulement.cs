...
{
    [ItemId(ItemIdEnum.PRECURSEUR_MAJEUR_13807)] // ID ITEM - NOM 
    public class Feulement : BasePlayerItem
    {
        public Feulement(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9331; //ID SORT
            string name = "Feulement";//NOM SORT
