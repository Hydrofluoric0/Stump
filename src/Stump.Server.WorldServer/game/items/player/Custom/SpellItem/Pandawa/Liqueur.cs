...
{
    [ItemId(ItemIdEnum.CARAPACE_NEUTRE_16319)] // ID ITEM - NOM 
    public class Liqueur : BasePlayerItem
    {
        public Liqueur(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9745; //ID SORT
            string name = "Liqueur";//NOM SORT
