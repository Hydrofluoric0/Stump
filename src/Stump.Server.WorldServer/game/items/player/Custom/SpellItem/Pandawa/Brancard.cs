...
{
    [ItemId(ItemIdEnum.CARAPACE_TERRE_MAJEUR_16316)] // ID ITEM - NOM 
    public class Brancard : BasePlayerItem
    {
        public Brancard(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9780; //ID SORT
            string name = "Brancard";//NOM SORT
