...
{
    [ItemId(ItemIdEnum.FEROCE_MINEUR_13832)] // ID ITEM - NOM 
    public class Picole : BasePlayerItem
    {
        public Picole(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 686; //ID SORT
            string name = "Picole";//NOM SORT
