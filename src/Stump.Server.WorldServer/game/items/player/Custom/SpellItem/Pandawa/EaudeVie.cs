...
{
    [ItemId(ItemIdEnum.CARAPACE_TERRE_16315)] // ID ITEM - NOM 
    public class EaudeVie : BasePlayerItem
    {
        public EaudeVie(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9744; //ID SORT
            string name = "Eau de Vie";//NOM SORT
