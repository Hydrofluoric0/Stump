...
{
    [ItemId(ItemIdEnum.CARAPACE_NEUTRE_MAJEUR_16320)] // ID ITEM - NOM 
    public class Consolation : BasePlayerItem
    {
        public Consolation(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9742; //ID SORT
            string name = "Consolation";//NOM SORT
