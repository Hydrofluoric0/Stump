...
{
    [ItemId(ItemIdEnum.CARAPACE_NEUTRE_MINEUR_16318)] // ID ITEM - NOM 
    public class Bistouille : BasePlayerItem
    {
        public Bistouille(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9778; //ID SORT
            string name = "Bistouille";//NOM SORT
