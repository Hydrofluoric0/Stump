...
{
    [ItemId(ItemIdEnum.FEROCE_13833)] // ID ITEM - NOM 
    public class GueuledeBois : BasePlayerItem
    {
        public GueuledeBois(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9739; //ID SORT
            string name = "Gueule de Bois";//NOM SORT
