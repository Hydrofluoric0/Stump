...
{
    [ItemId(ItemIdEnum.CARAPACE_TERRE_MINEUR_16314)] // ID ITEM - NOM 
    public class Gnôle : BasePlayerItem
    {
        public Gnôle(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9775; //ID SORT
            string name = "Gnôle";//NOM SORT
