...
{
    [ItemId(ItemIdEnum.SACCAGEUR_NEUTRE_13776)] // ID ITEM - NOM 
    public class Glypheprotecteur : BasePlayerItem
    {
        public Glypheprotecteur(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9534; //ID SORT
            string name = "Glyphe protecteur";//NOM SORT
