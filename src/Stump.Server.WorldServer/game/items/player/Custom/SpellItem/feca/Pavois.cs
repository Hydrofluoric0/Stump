...
{
    [ItemId(ItemIdEnum.SACCAGEUR_TERRE_MINEUR_13772)] // ID ITEM - NOM 
    public class Pavois : BasePlayerItem
    {
        public Pavois(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9529; //ID SORT
            string name = "Pavois";//NOM SORT
