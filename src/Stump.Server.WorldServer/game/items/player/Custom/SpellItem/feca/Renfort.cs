...
{
    [ItemId(ItemIdEnum.SACCAGEUR_NEUTRE_MINEUR_13775)] // ID ITEM - NOM 
    public class Renfort : BasePlayerItem
    {
        public Renfort(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9533; //ID SORT
            string name = "Renfort";//NOM SORT
