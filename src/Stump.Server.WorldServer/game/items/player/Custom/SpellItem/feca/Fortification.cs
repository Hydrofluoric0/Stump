...
{
    [ItemId(ItemIdEnum.BASTION_13770)] // ID ITEM - NOM 
    public class Fortification : BasePlayerItem
    {
        public Fortification(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9522; //ID SORT
            string name = "Fortification";//NOM SORT
