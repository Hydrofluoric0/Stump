...
{
    [ItemId(ItemIdEnum.SACCAGEUR_FEU_13779)] // ID ITEM - NOM 
    public class Inertie : BasePlayerItem
    {
        public Inertie(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9539; //ID SORT
            string name = "Inertie";//NOM SORT
