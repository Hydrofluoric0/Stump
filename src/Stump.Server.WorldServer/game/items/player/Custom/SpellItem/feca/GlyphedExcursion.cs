...
{
    [ItemId(ItemIdEnum.SACCAGEUR_NEUTRE_MAJEUR_13777)] // ID ITEM - NOM 
    public class GlyphedExcursion : BasePlayerItem
    {
        public GlyphedExcursion(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9537; //ID SORT
            string name = "Glyphe d'Excursion";//NOM SORT
