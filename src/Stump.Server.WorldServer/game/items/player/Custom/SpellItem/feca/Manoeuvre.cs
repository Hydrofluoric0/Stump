...
{
    [ItemId(ItemIdEnum.SACCAGEUR_TERRE_MAJEUR_13774)] // ID ITEM - NOM 
    public class Manoeuvre : BasePlayerItem
    {
        public Manoeuvre(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9525; //ID SORT
            string name = "Manoeuvre";//NOM SORT
