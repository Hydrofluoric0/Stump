...
{
    [ItemId(ItemIdEnum.SACCAGEUR_TERRE_13773)] // ID ITEM - NOM 
    public class Barriere : BasePlayerItem
    {
        public Barriere(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9532; //ID SORT
            string name = "Barriere";//NOM SORT
