...
{
    [ItemId(ItemIdEnum.ENGOURDISSEUR_12632)] // ID ITEM - NOM 
    public class Menace : BasePlayerItem
    {
        public Menace(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9626; //ID SORT
            string name = "Menace";//NOM SORT
