...
{
    [ItemId(ItemIdEnum.FUGITIF_12635)] // ID ITEM - NOM 
    public class Violence : BasePlayerItem
    {
        public Violence(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9633; //ID SORT
            string name = "Violence";//NOM SORT
