...
{
    [ItemId(ItemIdEnum.ENGOURDISSEUR_MINEUR_12631)] // ID ITEM - NOM 
    public class Condamnation : BasePlayerItem
    {
        public Condamnation(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9672; //ID SORT
            string name = "Condamnation";//NOM SORT
