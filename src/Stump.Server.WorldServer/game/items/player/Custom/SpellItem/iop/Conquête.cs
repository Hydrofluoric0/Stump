...
{
    [ItemId(ItemIdEnum.TACLEUR_MINEUR_12622)] // ID ITEM - NOM 
    public class Conquête : BasePlayerItem
    {
        public Conquête(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9645; //ID SORT
            string name = "Conquête";//NOM SORT
