...
{
    [ItemId(ItemIdEnum.ENGOURDISSEUR_MAJEUR_12633)] // ID ITEM - NOM 
    public class Fendoir : BasePlayerItem
    {
        public Fendoir(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9630; //ID SORT
            string name = "Fendoir";//NOM SORT
