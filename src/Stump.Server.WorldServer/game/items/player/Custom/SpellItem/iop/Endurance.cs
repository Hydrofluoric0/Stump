...
{
    [ItemId(ItemIdEnum.TACLEUR_12623)] // ID ITEM - NOM 
    public class Endurance : BasePlayerItem
    {
        public Endurance(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9629; //ID SORT
            string name = "Endurance";//NOM SORT
