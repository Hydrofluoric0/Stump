...
{
    [ItemId(ItemIdEnum.FUGITIF_MAJEUR_12636)] // ID ITEM - NOM 
    public class Détermination : BasePlayerItem
    {
        public Détermination(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9628; //ID SORT
            string name = "Détermination";//NOM SORT
