...
{
    [ItemId(ItemIdEnum.MURAILLE_AIR_MINEURE_13820)] // ID ITEM - NOM 
    public class Humérus : BasePlayerItem
    {
        public Humérus(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9692; //ID SORT
            string name = "Humérus";//NOM SORT
