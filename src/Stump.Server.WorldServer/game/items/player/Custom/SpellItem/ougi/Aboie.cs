...
{
    [ItemId(ItemIdEnum.ROBUSTE_13827)] // ID ITEM - NOM 
    public class Aboie : BasePlayerItem
    {
        public Aboie(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9687; //ID SORT
            string name = "Aboie";//NOM SORT
