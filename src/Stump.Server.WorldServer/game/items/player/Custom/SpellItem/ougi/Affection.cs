...
{
    [ItemId(ItemIdEnum.TURBULENT_13829)] // ID ITEM - NOM 
    public class Affection : BasePlayerItem
    {
        public Affection(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9689; //ID SORT
            string name = "Affection";//NOM SORT
