...
{
    [ItemId(ItemIdEnum.VOYAGEUR_13830)] // ID ITEM - NOM 
    public class Poursuite : BasePlayerItem
    {
        public Poursuite(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9699; //ID SORT
            string name = "Poursuite";//NOM SORT
