...
{
    [ItemId(ItemIdEnum.MURAILLE_AIR_MAJEURE_13822)] // ID ITEM - NOM 
    public class Battue : BasePlayerItem
    {
        public Battue(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9694; //ID SORT
            string name = "Battue";//NOM SORT
