...
{
    [ItemId(ItemIdEnum.EXAMINATEUR_13831)] // ID ITEM - NOM 
    public class Rogne : BasePlayerItem
    {
        public Rogne(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9701; //ID SORT
            string name = "Rogne";//NOM SORT
