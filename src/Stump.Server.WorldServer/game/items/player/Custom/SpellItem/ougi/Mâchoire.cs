...
{
    [ItemId(ItemIdEnum.SOIGNEUR_12709)] // ID ITEM - NOM 
    public class Mâchoire : BasePlayerItem
    {
        public Mâchoire(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9684; //ID SORT
            string name = "Mâchoire";//NOM SORT
