...
{
    [ItemId(ItemIdEnum.ROBUSTE_MAJEUR_13828)] // ID ITEM - NOM 
    public class Radius : BasePlayerItem
    {
        public Radius(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9697; //ID SORT
            string name = "Radius";//NOM SORT
