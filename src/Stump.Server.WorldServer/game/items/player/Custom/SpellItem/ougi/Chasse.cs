...
{
    [ItemId(ItemIdEnum.MURAILLE_AIR_13821)] // ID ITEM - NOM 
    public class Chasse : BasePlayerItem
    {
        public Chasse(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9693; //ID SORT
            string name = "Chasse";//NOM SORT
