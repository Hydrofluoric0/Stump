...
{
    [ItemId(ItemIdEnum.ROBUSTE_MINEUR_13826)] // ID ITEM - NOM 
    public class Dépouille : BasePlayerItem
    {
        public Dépouille(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9686; //ID SORT
            string name = "Dépouille";//NOM SORT
