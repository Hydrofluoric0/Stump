...
{
    [ItemId(ItemIdEnum.CASCADEUR_16244)] // ID ITEM - NOM 
    public class PiegeFragmentation : BasePlayerItem
    {
        public PiegeFragmentation(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9804; //ID SORT
            string name = "Piège à Fragmentation";//NOM SORT
