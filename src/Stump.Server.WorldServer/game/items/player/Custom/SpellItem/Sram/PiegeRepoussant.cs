...
{
    [ItemId(ItemIdEnum.CASCADEUR_MINEUR_16243)] // ID ITEM - NOM 
    public class PiegeRepoussant : BasePlayerItem
    {
        public PiegeRepoussant(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9808; //ID SORT
            string name = "Piège Repoussant";//NOM SORT
