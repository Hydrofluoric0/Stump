...
{
    [ItemId(ItemIdEnum.OBSERVATEUR_16336)] // ID ITEM - NOM 
    public class Traquenard : BasePlayerItem
    {
        public Traquenard(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9801; //ID SORT
            string name = "Traquenard";//NOM SORT
