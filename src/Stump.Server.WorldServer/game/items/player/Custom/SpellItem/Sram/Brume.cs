...
{
    [ItemId(ItemIdEnum.INFLEXIBLE_MAJEUR_13804)] // ID ITEM - NOM 
    public class Brume : BasePlayerItem
    {
        public Brume(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9793; //ID SORT
            string name = "Brume";//NOM SORT
