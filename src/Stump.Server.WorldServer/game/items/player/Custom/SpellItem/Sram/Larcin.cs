...
{
    [ItemId(ItemIdEnum.NOMADE_16335)] // ID ITEM - NOM 
    public class Larcin : BasePlayerItem
    {
        public Larcin(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9800; //ID SORT
            string name = "Larcin";//NOM SORT
