...
{
    [ItemId(ItemIdEnum.CHANCEUX_16247)] // ID ITEM - NOM 
    public class Perfide : BasePlayerItem
    {
        public Perfide(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9813; //ID SORT
            string name = "Perfide";//NOM SORT
