...
{
    [ItemId(ItemIdEnum.CHANCEUX_MINEUR_16246)] // ID ITEM - NOM 
    public class PiegeFuneste : BasePlayerItem
    {
        public PiegeFuneste(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9812; //ID SORT
            string name = "Piège Funeste";//NOM SORT
