...
{
    [ItemId(ItemIdEnum.VIGOUREUX_MAJEUR_16332)] // ID ITEM - NOM 
    public class ChausseTrappe : BasePlayerItem
    {
        public ChausseTrappe(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9795; //ID SORT
            string name = "Chausse-Trappe";//NOM SORT
