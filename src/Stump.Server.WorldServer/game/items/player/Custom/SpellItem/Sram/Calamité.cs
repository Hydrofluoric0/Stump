...
{
    [ItemId(ItemIdEnum.CHANCEUX_MAJEUR_16248)] // ID ITEM - NOM 
    public class Calamité : BasePlayerItem
    {
        public Calamité(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9814; //ID SORT
            string name = "Calamité";//NOM SORT
