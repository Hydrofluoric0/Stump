...
{
    [ItemId(ItemIdEnum.REMUEUR_16333)] // ID ITEM - NOM 
    public class Pillages : BasePlayerItem
    {
        public Pillages(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
