...
{
    [ItemId(ItemIdEnum.RAVAGEUR_NEUTRE_12695)] // ID ITEM - NOM 
    public class Virus : BasePlayerItem
    {
        public Virus(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9390; //ID SORT
            string name = "Virus";//NOM SORT
