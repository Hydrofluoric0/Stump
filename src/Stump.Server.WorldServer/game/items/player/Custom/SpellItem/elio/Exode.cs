...
{
    [ItemId(ItemIdEnum.RAVAGEUR_FEU_MAJEUR_12693)] // ID ITEM - NOM 
    public class Exode : BasePlayerItem
    {
        public Exode(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9387; //ID SORT
            string name = "Exode";//NOM SORT
