...
{
    [ItemId(ItemIdEnum.RAVAGEUR_NEUTRE_MAJEUR_12697)] // ID ITEM - NOM 
    public class Coalition : BasePlayerItem
    {
        public Coalition(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9392; //ID SORT
            string name = "Coalition";//NOM SORT
