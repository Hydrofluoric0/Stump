...
{
    [ItemId(ItemIdEnum.RAVAGEUR_AIR_MINEUR_12688)] // ID ITEM - NOM 
    public class Contractio : BasePlayerItem
    {
        public Contractio(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9380; //ID SORT
            string name = "Contraction";//NOM SORT
