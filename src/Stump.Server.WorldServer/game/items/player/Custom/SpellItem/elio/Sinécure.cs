...
{
    [ItemId(ItemIdEnum.RAVAGEUR_EAU_12689)] // ID ITEM - NOM 
    public class Sinécure : BasePlayerItem
    {
        public Sinécure(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9381; //ID SORT
            string name = "Sinécure";//NOM SORT
