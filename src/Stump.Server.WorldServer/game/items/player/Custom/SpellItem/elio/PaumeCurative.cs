...
{
    [ItemId(ItemIdEnum.RAVAGEUR_FEU_12692)] // ID ITEM - NOM 
    public class PaumeCurative : BasePlayerItem
    {
        public PaumeCurative(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9386; //ID SORT
            string name = "Paume Curative";//NOM SORT
