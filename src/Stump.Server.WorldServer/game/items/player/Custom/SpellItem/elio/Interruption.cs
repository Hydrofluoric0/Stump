...
{
    [ItemId(ItemIdEnum.RAVAGEUR_AIR_MAJEUR_12687)] // ID ITEM - NOM 
    public class Interruption : BasePlayerItem
    {
        public Interruption(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9378; //ID SORT
            string name = "Interruption";//NOM SORT
