...
{
    [ItemId(ItemIdEnum.RAVAGEUR_EAU_MAJEUR_12690)] // ID ITEM - NOM 
    public class Conjuration : BasePlayerItem
    {
        public Conjuration(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9385; //ID SORT
            string name = "Conjuration";//NOM SORT
