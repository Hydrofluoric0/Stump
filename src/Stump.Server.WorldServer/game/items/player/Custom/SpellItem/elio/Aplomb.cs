...
{
    [ItemId(ItemIdEnum.RAVAGEUR_FEU_MINEUR_12694)] // ID ITEM - NOM 
    public class Aplomb : BasePlayerItem
    {
        public Aplomb(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9389; //ID SORT
            string name = "Aplomb";//NOM SORT
