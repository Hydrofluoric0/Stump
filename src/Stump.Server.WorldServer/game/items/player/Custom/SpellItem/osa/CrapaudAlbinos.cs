...
{
    [ItemId(ItemIdEnum.IMPRENABLE_MAJEUR_13795)] // ID ITEM - NOM 
    public class CrapauxAlbinos : BasePlayerItem
    {
        public CrapauxAlbinos(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9658; //ID SORT
            string name = "Crapaux Albinos";//NOM SORT
