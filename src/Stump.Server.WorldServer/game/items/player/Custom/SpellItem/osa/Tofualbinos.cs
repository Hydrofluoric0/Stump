...
{
    [ItemId(ItemIdEnum.IMPRENABLE_MINEUR_13793)] // ID ITEM - NOM 
    public class Tofualbinos : BasePlayerItem
    {
        public Tofualbinos(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9653; //ID SORT
            string name = "Tofu albinos";//NOM SORT
