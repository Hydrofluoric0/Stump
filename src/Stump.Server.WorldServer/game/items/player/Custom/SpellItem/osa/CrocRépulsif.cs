...
{
    [ItemId(ItemIdEnum.PARALYSEUR_MAJEUR_13792)] // ID ITEM - NOM 
    public class CrocRépulsif : BasePlayerItem
    {
        public CrocRépulsif(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9651; //ID SORT
            string name = "Croc Répulsif";//NOM SORT
