...
{
    [ItemId(ItemIdEnum.IMPRENABLE_13794)] // ID ITEM - NOM 
    public class BaumeProtecteur : BasePlayerItem
    {
        public BaumeProtecteur(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9657; //ID SORT
            string name = "Baume Protecteur";//NOM SORT
