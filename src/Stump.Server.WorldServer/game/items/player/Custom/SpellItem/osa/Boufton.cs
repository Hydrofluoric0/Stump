...
{
    [ItemId(ItemIdEnum.EVANESCENT_13797)] // ID ITEM - NOM 
    public class Boufton : BasePlayerItem
    {
        public Boufton(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9661; //ID SORT
            string name = "Boufton";//NOM SORT
