...
{
    [ItemId(ItemIdEnum.EVANESCENT_MINEUR_13796)] // ID ITEM - NOM 
    public class Cravache : BasePlayerItem
    {
        public Cravache(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9659; //ID SORT
            string name = "Cravache";//NOM SORT
