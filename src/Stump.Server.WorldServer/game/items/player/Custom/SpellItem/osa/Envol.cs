...
{
    [ItemId(ItemIdEnum.BOUSCULEUR_MINEUR_13799)] // ID ITEM - NOM 
    public class Envol : BasePlayerItem
    {
        public Envol(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 23; //ID SORT
            string name = "Envol";//NOM SORT
