...
{
    [ItemId(ItemIdEnum.EVANESCENT_MAJEUR_13798)] // ID ITEM - NOM 
    public class Favoritisme : BasePlayerItem
    {
        public Favoritisme(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 9669; //ID SORT
            string name = "Favoritisme";//NOM SORT
