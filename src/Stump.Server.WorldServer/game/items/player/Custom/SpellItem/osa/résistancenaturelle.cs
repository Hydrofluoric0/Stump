...
{
    [ItemId(ItemIdEnum.PARALYSEUR_13791)] // ID ITEM - NOM 
    public class résistancenaturelle : BasePlayerItem
    {
        public résistancenaturelle(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        {
            var spellid = 32; //ID SORT
            string name = "résistance naturelle";//NOM SORT
