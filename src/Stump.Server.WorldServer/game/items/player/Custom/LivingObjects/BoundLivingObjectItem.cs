...
namespace Stump.Server.WorldServer.Game.Items.Player.Custom.LivingObjects
{
    ...
    public sealed class BoundLivingObjectItem : CommonLivingObject
    {
        ...
        public override bool Feed(BasePlayerItem food)
        {
            ...
            if ((LivingObjectRecord.Id == 19525 || LivingObjectRecord.Id == 19526 || LivingObjectRecord.Id == 19524 || LivingObjectRecord.Id == 23022 || LivingObjectRecord.Id == 23023 || LivingObjectRecord.Id == 23024) && Level >= 10)
                return false;

            var xp = (short)Math.Ceiling(food.Template.Level/2d);
            if(xp + Experience > 126 && (LivingObjectRecord.Id == 19525 || LivingObjectRecord.Id == 19526 || LivingObjectRecord.Id == 19524 || LivingObjectRecord.Id == 23022 || LivingObjectRecord.Id == 23023 || LivingObjectRecord.Id == 23024))
            {
                Experience = 126;
            }
            else
