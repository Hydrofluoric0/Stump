...
//        public int idInDungeon(int id, List<MonsterDungeonSpawn> spawn_dungeons)
//        {
//            int i = 0;
//            foreach (var s in spawn_dungeons)
//            {
//                if (s.Id == id)
//                    return i;
//                i++;
...
//            var ntm = Database.Query<MonsterDungeonSpawnEntity>(MonsterDungeonSpawnRelator.FetchNtm).ToList();
...
//            List<MonsterDungeonSpawn> spawn_dungeons = new List<MonsterDungeonSpawn>();
//            foreach (var spawn in s)
//            {
//                int res = idInDungeon(spawn.Id, spawn_dungeons);
//                if (res != -1)
//                {
//                    var groups = spawn.GroupMonsters;
//                    foreach (var g in groups)
//                    {
//                        spawn_dungeons[res].GroupMonsters.Add(g);
//                    }
//                }
//                else
//                {
//                    spawn_dungeons.Add(spawn);
//                }
//            }



//            m_monsterDungeonsSpawns = new Dictionary<int, MonsterDungeonSpawn>();

//            foreach(var ntr in spawn_dungeons)
//            {
//                if(ntr.GroupMonsters.Count > 0)
//                {
//                    foreach(var ntms in ntr.GroupMonsters)
//                    {
//                        ntms.MinPartyMembers = ntm.FirstOrDefault(x => x.Id == ntms.Id)?.MinPartyMembers;
//                    }
//                }
//            }


//            foreach (var a in spawn_dungeons)
//            {
//                if (a.GroupMonsters.Count > 0)
//                    m_monsterDungeonsSpawns.Add(a.Id, a);
//            }
