...
namespace Stump.Server.WorldServer.Commands.Commands.Teleport
{
    public class DjPanel : CommandBase
    {
        ...
        public override void Execute(TriggerBase trigger)
        {
            ...
            destinations.Add(World.Instance.GetMap(137102336), 420);
            destinations.Add(World.Instance.GetMap(136578048), 256);
            destinations.Add(World.Instance.GetMap(136840192), 504);
            destinations.Add(World.Instance.GetMap(130548736), 266);
            destinations.Add(World.Instance.GetMap(129500160), 337);
            destinations.Add(World.Instance.GetMap(143917569), 226);
            destinations.Add(World.Instance.GetMap(143393281), 479);
            destinations.Add(World.Instance.GetMap(162004992), 506);
            destinations.Add(World.Instance.GetMap(160564224), 206);
            destinations.Add(World.Instance.GetMap(140771328), 459);
            destinations.Add(World.Instance.GetMap(119277057), 240);
            destinations.Add(World.Instance.GetMap(110100480), 465);
            destinations.Add(World.Instance.GetMap(173934082), 285);
            destinations.Add(World.Instance.GetMap(187957506), 473);
            destinations.Add(World.Instance.GetMap(182714368), 362);
            destinations.Add(World.Instance.GetMap(107481088), 553);
            destinations.Add(World.Instance.GetMap(195035136), 553);
